...
## Run Information
- Mayhem Run: mayhemheroes/agnes/agnes-fuzz/1
- Git Commit: 93904e5cd767f1d5e93393cdd9947e31bb1688fe
- Original Image: ghcr.io/mayhemheroes/agnes:master
- Target Executable: ./agnes-fuzz
- CI URL: https://github.com:443/mayhemheroes/agnes//actions/runs/4905646032
...
- Source code: `/rlenv/source/agnes/`
...
RUN cp <build-artifact> ./agnes-fuzz

# 11. Permission Management (REQUIRED)
RUN chmod 766 ./agnes-fuzz
...
- `COPY . /rlenv/source/agnes/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/agnes/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 ./agnes-fuzz`
...
- [ ] Target executable in Dockerfile.rlenv: `./agnes-fuzz`
- [ ] Target executable in build.sh: `./agnes-fuzz`
- [ ] Target executable in metadata.json: `./agnes-fuzz`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/agnes/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/agnes/fuzz
...
- Source copy: `COPY . /rlenv/source/agnes/`
...
- Working directory: `cd /rlenv/source/agnes/`
- No network access
